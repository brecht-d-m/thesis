...
object LDFSparkLoaderJobIndexTableSorted extends SparkSqlJob {
  ...
  def readFile(file: RDD[String], sc: SQLContext) = {
    ...
    var triplesParquetFileS = sc.read.parquet("triple_table_spark.parquet")
    triplesParquetFileS = triplesParquetFileS.sort("subjectTripleObjectIndex")
    triplesParquetFileS.registerTempTable("triple_table_s")
    sc.cacheTable("triple_table_s")

    var triplesParquetFileP = sc.read.parquet("triple_table_spark.parquet")
    triplesParquetFileP = triplesParquetFileP.sort("predicateTripleObjectIndex")
    triplesParquetFileP.registerTempTable("triple_table_p")
    sc.cacheTable("triple_table_p")

    var triplesParquetFileO = sc.read.parquet("triple_table_spark.parquet")
    triplesParquetFileO = triplesParquetFileO.sort("objectTripleObjectIndex")
    triplesParquetFileO.registerTempTable("triple_table_o")
    sc.cacheTable("triple_table_o")
